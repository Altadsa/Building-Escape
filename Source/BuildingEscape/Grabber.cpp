...
void UGrabber::BeginPlay()
{
	...
	if (PhysicsHandle != nullptr || InputComponent != nullptr)
	{
		//Both Components are found...
	...
	{
		UE_LOG(LogTemp, Error, TEXT("%s Physics Handle/ Input Component not found"), *GetOwner()->GetName())
	}
